...
rem for /f "tokens=3 delims= " %%b in (
rem     'reg query "hklm\system\controlset001\control\nls\language" /v Installlanguage'
rem ) do set "langnum=%%b"
rem     if "%langnum%"=="0409" set "lang=English" & goto :English
rem     if "%langnum%"=="041F" set "lang=Turkish" & goto :Turkish
rem     if "%langnum%"=="0400" set "lang=Vietnam" & goto :Vietnam
rem     if "%langnum%"=="0804" set "lang=SimplifiedChinese" & goto :SimplifiedChinese
rem     set "lang=English" & goto :English
...
rem >> [ 01 ] Install Multiboot
set "_lang0101_=Nhập số thứ tự của thiết bị muốn tạo boot [ ? ] = "
